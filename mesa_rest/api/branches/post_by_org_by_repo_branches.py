...
def _get_kwargs(
    ...
    repo: str,
    *,
    body: PostByOrgByRepoBranchesBody,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PostByOrgByRepoBranchesResponse201 | PostByOrgByRepoBranchesResponse400 | PostByOrgByRepoBranchesResponse401 | PostByOrgByRepoBranchesResponse403 | PostByOrgByRepoBranchesResponse404 | PostByOrgByRepoBranchesResponse406 | PostByOrgByRepoBranchesResponse409 | PostByOrgByRepoBranchesResponse500 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[PostByOrgByRepoBranchesResponse201 | PostByOrgByRepoBranchesResponse400 | PostByOrgByRepoBranchesResponse401 | PostByOrgByRepoBranchesResponse403 | PostByOrgByRepoBranchesResponse404 | PostByOrgByRepoBranchesResponse406 | PostByOrgByRepoBranchesResponse409 | PostByOrgByRepoBranchesResponse500]:
    return Response(
...
) -> PostByOrgByRepoBranchesResponse201 | PostByOrgByRepoBranchesResponse400 | PostByOrgByRepoBranchesResponse401 | PostByOrgByRepoBranchesResponse403 | PostByOrgByRepoBranchesResponse404 | PostByOrgByRepoBranchesResponse406 | PostByOrgByRepoBranchesResponse409 | PostByOrgByRepoBranchesResponse500 | None:
    """ Create branch
