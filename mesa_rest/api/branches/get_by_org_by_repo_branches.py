...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{org}/{repo}/branches".format(org=quote(str(org), safe=""),repo=quote(str(repo), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> GetByOrgByRepoBranchesResponse200 | GetByOrgByRepoBranchesResponse400 | GetByOrgByRepoBranchesResponse401 | GetByOrgByRepoBranchesResponse403 | GetByOrgByRepoBranchesResponse404 | GetByOrgByRepoBranchesResponse406 | GetByOrgByRepoBranchesResponse409 | GetByOrgByRepoBranchesResponse500 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[GetByOrgByRepoBranchesResponse200 | GetByOrgByRepoBranchesResponse400 | GetByOrgByRepoBranchesResponse401 | GetByOrgByRepoBranchesResponse403 | GetByOrgByRepoBranchesResponse404 | GetByOrgByRepoBranchesResponse406 | GetByOrgByRepoBranchesResponse409 | GetByOrgByRepoBranchesResponse500]:
    return Response(
...
) -> GetByOrgByRepoBranchesResponse200 | GetByOrgByRepoBranchesResponse400 | GetByOrgByRepoBranchesResponse401 | GetByOrgByRepoBranchesResponse403 | GetByOrgByRepoBranchesResponse404 | GetByOrgByRepoBranchesResponse406 | GetByOrgByRepoBranchesResponse409 | GetByOrgByRepoBranchesResponse500 | None:
    """ List branches
