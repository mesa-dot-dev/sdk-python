...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/{org}/{repo}/branches/{branch}".format(org=quote(str(org), safe=""),repo=quote(str(repo), safe=""),branch=quote(str(branch), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> DeleteByOrgByRepoBranchesByBranchResponse200 | DeleteByOrgByRepoBranchesByBranchResponse400 | DeleteByOrgByRepoBranchesByBranchResponse401 | DeleteByOrgByRepoBranchesByBranchResponse403 | DeleteByOrgByRepoBranchesByBranchResponse404 | DeleteByOrgByRepoBranchesByBranchResponse406 | DeleteByOrgByRepoBranchesByBranchResponse409 | DeleteByOrgByRepoBranchesByBranchResponse500 | None:
