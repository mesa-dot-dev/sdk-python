...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{org}".format(org=quote(str(org), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> GetByOrgResponse200 | GetByOrgResponse400 | GetByOrgResponse401 | GetByOrgResponse403 | GetByOrgResponse404 | GetByOrgResponse406 | GetByOrgResponse409 | GetByOrgResponse500 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[GetByOrgResponse200 | GetByOrgResponse400 | GetByOrgResponse401 | GetByOrgResponse403 | GetByOrgResponse404 | GetByOrgResponse406 | GetByOrgResponse409 | GetByOrgResponse500]:
    return Response(
...
) -> GetByOrgResponse200 | GetByOrgResponse400 | GetByOrgResponse401 | GetByOrgResponse403 | GetByOrgResponse404 | GetByOrgResponse406 | GetByOrgResponse409 | GetByOrgResponse500 | None:
    """ Get organization
