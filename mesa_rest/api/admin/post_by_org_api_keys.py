...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PostByOrgApiKeysResponse201 | PostByOrgApiKeysResponse400 | PostByOrgApiKeysResponse401 | PostByOrgApiKeysResponse403 | PostByOrgApiKeysResponse404 | PostByOrgApiKeysResponse406 | PostByOrgApiKeysResponse409 | PostByOrgApiKeysResponse500 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[PostByOrgApiKeysResponse201 | PostByOrgApiKeysResponse400 | PostByOrgApiKeysResponse401 | PostByOrgApiKeysResponse403 | PostByOrgApiKeysResponse404 | PostByOrgApiKeysResponse406 | PostByOrgApiKeysResponse409 | PostByOrgApiKeysResponse500]:
    return Response(
...
) -> PostByOrgApiKeysResponse201 | PostByOrgApiKeysResponse400 | PostByOrgApiKeysResponse401 | PostByOrgApiKeysResponse403 | PostByOrgApiKeysResponse404 | PostByOrgApiKeysResponse406 | PostByOrgApiKeysResponse409 | PostByOrgApiKeysResponse500 | None:
    """ Create API key
