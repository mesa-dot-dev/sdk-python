...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{org}/{repo}/commits/{sha}".format(org=quote(str(org), safe=""),repo=quote(str(repo), safe=""),sha=quote(str(sha), safe=""),),
    }
