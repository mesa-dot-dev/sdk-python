...
from ..models.patch_by_org_by_repo_body_upstream_type_0_autosync_type_0_resolution_strategy import PatchByOrgByRepoBodyUpstreamType0AutosyncType0ResolutionStrategy
from ..types import UNSET, Unset
...
class PatchByOrgByRepoBodyUpstreamType0AutosyncType0:
    ...
    type_: Literal['poll']
    period: int
    resolution_strategy: PatchByOrgByRepoBodyUpstreamType0AutosyncType0ResolutionStrategy | Unset = PatchByOrgByRepoBodyUpstreamType0AutosyncType0ResolutionStrategy.NONE
