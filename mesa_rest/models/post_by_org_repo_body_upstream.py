...
if TYPE_CHECKING:
  from ..models.post_by_org_repo_body_upstream_autosync_type_0 import PostByOrgRepoBodyUpstreamAutosyncType0





T = TypeVar("T", bound="PostByOrgRepoBodyUpstream")



@_attrs_define
class PostByOrgRepoBodyUpstream:
    """ 
        Attributes:
            uri (str): URL of the upstream repository
            autosync (PostByOrgRepoBodyUpstreamAutosyncType0 | Unset): Optionally enable automatic sync from the upstream
                repository
    ...
    uri: str
    autosync: PostByOrgRepoBodyUpstreamAutosyncType0 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_autosync(data: object) -> PostByOrgRepoBodyUpstreamAutosyncType0 | Unset:
            if isinstance(data, Unset):
                return data
            if not isinstance(data, dict):
                raise TypeError()
            autosync_type_0 = PostByOrgRepoBodyUpstreamAutosyncType0.from_dict(data)
        ...
        post_by_org_repo_body_upstream = cls(
            uri=uri,
            autosync=autosync,
            token=token,
        ...
        post_by_org_repo_body_upstream.additional_properties = d
        return post_by_org_repo_body_upstream
