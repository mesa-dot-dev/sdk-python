...
if TYPE_CHECKING:
  from ..models.post_by_org_repos_response_201_upstream_type_0_autosync_type_0 import PostByOrgReposResponse201UpstreamType0AutosyncType0





T = TypeVar("T", bound="PostByOrgReposResponse201UpstreamType0")



@_attrs_define
class PostByOrgReposResponse201UpstreamType0:
    """ 
        Attributes:
            uri (str): URL of the upstream repository
            autosync (None | PostByOrgReposResponse201UpstreamType0AutosyncType0): Automatic sync configuration, if enabled
    ...
    uri: str
    autosync: None | PostByOrgReposResponse201UpstreamType0AutosyncType0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.autosync, PostByOrgReposResponse201UpstreamType0AutosyncType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_autosync(data: object) -> None | PostByOrgReposResponse201UpstreamType0AutosyncType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                autosync_type_0 = PostByOrgReposResponse201UpstreamType0AutosyncType0.from_dict(data)
                ...
                pass
            return cast(None | PostByOrgReposResponse201UpstreamType0AutosyncType0, data)
        ...
        post_by_org_repos_response_201_upstream_type_0 = cls(
            uri=uri,
            autosync=autosync,
            last_sync_attempt=last_sync_attempt,
            last_sync_success=last_sync_success,
        ...
        post_by_org_repos_response_201_upstream_type_0.additional_properties = d
        return post_by_org_repos_response_201_upstream_type_0
