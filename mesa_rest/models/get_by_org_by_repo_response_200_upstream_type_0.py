...
if TYPE_CHECKING:
  from ..models.get_by_org_by_repo_response_200_upstream_type_0_autosync_type_0 import GetByOrgByRepoResponse200UpstreamType0AutosyncType0





T = TypeVar("T", bound="GetByOrgByRepoResponse200UpstreamType0")



@_attrs_define
class GetByOrgByRepoResponse200UpstreamType0:
    """ 
        Attributes:
            uri (str): URL of the upstream repository
            autosync (GetByOrgByRepoResponse200UpstreamType0AutosyncType0 | None): Automatic sync configuration, if enabled
    ...
    uri: str
    autosync: GetByOrgByRepoResponse200UpstreamType0AutosyncType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.autosync, GetByOrgByRepoResponse200UpstreamType0AutosyncType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_autosync(data: object) -> GetByOrgByRepoResponse200UpstreamType0AutosyncType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                autosync_type_0 = GetByOrgByRepoResponse200UpstreamType0AutosyncType0.from_dict(data)
                ...
                pass
            return cast(GetByOrgByRepoResponse200UpstreamType0AutosyncType0 | None, data)
        ...
        get_by_org_by_repo_response_200_upstream_type_0 = cls(
            uri=uri,
            autosync=autosync,
            last_sync_attempt=last_sync_attempt,
            last_sync_success=last_sync_success,
        ...
        get_by_org_by_repo_response_200_upstream_type_0.additional_properties = d
        return get_by_org_by_repo_response_200_upstream_type_0
