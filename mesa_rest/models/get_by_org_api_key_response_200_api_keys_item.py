...
T = TypeVar("T", bound="GetByOrgApiKeyResponse200ApiKeysItem")



@_attrs_define
class GetByOrgApiKeyResponse200ApiKeysItem:
    """ 
        Attributes:
            id (str):
            name (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_by_org_api_key_response_200_api_keys_item = cls(
            id=id,
            name=name,
            scopes=scopes,
            repo_ids=repo_ids,
        ...
        get_by_org_api_key_response_200_api_keys_item.additional_properties = d
        return get_by_org_api_key_response_200_api_keys_item
